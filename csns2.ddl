    ...
    alter table offered_sections 
        add constraint FK27ubpu17fnd46634bed7n7r0o 
        foreign key (course_id) 
        references courses;

    alter table pre_register_request_sections 
        add constraint FKknt3seesf47vsi2tuljynstni 
        foreign key (section_id) 
        references offered_sections;

    alter table pre_register_request_sections 
        add constraint FKcxtrx70upbx7u0mifqpo0kuoo 
        foreign key (request_id) 
        references pre_register_requests;

    alter table pre_register_requests 
        add constraint FKjg7b9dxwvbecjf7266qjyae9k 
        foreign key (user_id) 
        references users;
    ...
    alter table tentative_schedule_sections 
        add constraint FKasxrnkj3s7j5erwtol0q90cbi 
        foreign key (section_id) 
        references offered_sections;

    alter table tentative_schedule_sections 
        add constraint FKb5m5lrrhgprpntm1r8xl75mj4 
        foreign key (schedule_id) 
        references tentative_schedules;

    alter table tentative_schedules 
        add constraint FKhd44rmq5nfj1y7hj76cly6djd 
        foreign key (department_id) 
        references departments;
