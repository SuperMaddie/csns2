...
@Component
@Scope("prototype")
public class OfferedSectionPropertyEditor extends PropertyEditorSupport {

	@Autowired
	OfferedSectionDao offeredSectionDao;
    ...
    {
        OfferedSection section = (OfferedSection) getValue();
